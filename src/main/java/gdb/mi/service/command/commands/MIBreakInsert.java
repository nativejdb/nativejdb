...
public class MIBreakInsert extends MICommand<MIBreakInsertInfo> {
	/** @since 4.0 */
	public MIBreakInsert(String func, boolean allowPending) {
		this(false, false, null, 0, func, "0", allowPending); //$NON-NLS-1$
	}

	/** @since 5.0*/
	public MIBreakInsert(boolean isTemporary, boolean isHardware, String condition,
			int ignoreCount, String line, String tid, boolean allowPending) {
		this(isTemporary, isHardware, condition, ignoreCount, line, tid, false, false, allowPending);
	}

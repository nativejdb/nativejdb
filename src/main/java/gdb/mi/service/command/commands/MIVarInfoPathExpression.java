...
import gdb.mi.service.command.output.MIVarInfoPathExpressionInfo;
...
public class MIVarInfoPathExpression extends MICommand<MIVarInfoPathExpressionInfo> {
	 ...
	 * @since 1.1
	 */
	public MIVarInfoPathExpression(String name) {
		super("-var-info-path-expression", new String[] { name }); //$NON-NLS-1$
	}

...
public class MIListThreadGroups extends MICommand<MIListThreadGroupsInfo> {
	 ...
	 */
	public MIListThreadGroups(String groupId) {
		this(groupId, false, false);
	}
	 ...
	 */
	public MIListThreadGroups(boolean listAll) {
		this(null, listAll, false);
	}
	 ...
	 * @since 4.1
	 */
	public MIListThreadGroups(boolean listAll, boolean recurse) {
		this(null, listAll, recurse);
	}
	...
	private MIListThreadGroups(String groupId, boolean listAll, boolean recurse) {
		super( "-list-thread-groups"); //$NON-NLS-1$

...
import gdb.mi.service.command.output.MIVarListChildrenInfo;
...
public class MIVarListChildren extends MICommand<MIVarListChildrenInfo> {
	 ...
	 * @since 4.0
	 */
	public MIVarListChildren(String name, int from, int to) {
		super("-var-list-children", new String[] { name, String.valueOf(from), String.valueOf(to) }); //$NON-NLS-1$
	}

...
import gdb.mi.service.command.output.MIVarEvaluateExpressionInfo;
...
public class MIVarEvaluateExpression extends MICommand<MIVarEvaluateExpressionInfo> {
	 ...
	 * @since 1.1
	 */
	public MIVarEvaluateExpression( String name) {
		super("-var-evaluate-expression", new String[] { name }); //$NON-NLS-1$
	}

...
public class MIFunctionFinishedEvent extends MIStoppedEvent {
	...
	protected MIFunctionFinishedEvent(int token, MIResult[] results, MIFrame frame,
	 ...
	 * @since 1.1
	 */
	public static MIFunctionFinishedEvent parse(int token, MIResult[] results) {
		...
		return new MIFunctionFinishedEvent(token, results, stoppedEvent.getFrame(),

...
public class MIWatchpointTriggerEvent extends MIStoppedEvent {
	 ...
	 * @since 5.0
	 */
	protected MIWatchpointTriggerEvent(int token, MIResult[] results, MIFrame frame,
	 ...
	 * @since 1.1
	 */
	public static MIWatchpointTriggerEvent parse(int token, MIResult[] results) {
		...
		return new MIWatchpointTriggerEvent(token, results, stoppedEvent.getFrame(),
